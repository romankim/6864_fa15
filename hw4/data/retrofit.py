...
def read_word_vecs(filename):
  ...
  for line in fileObject:
    ...
    for index, vecVal in enumerate(vec):
...
#  outFileName = args.output
  ...
  lexicon = "framenet.txt"
  outFileName = "framenet-out.txt"
  wordVecs = read_word_vecs("GoogleNews-vectors-negative300-short.txt")
